...
//        creates context menu when item is right clicked
        ...
        todoListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TodoItem>() {
            ...
            public void changed(ObservableValue<? extends TodoItem> observable, TodoItem oldValue, TodoItem newValue) {
                if (newValue != null) {
                    ...
                    DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("MMM d, YY");
...
//        Link the ListView from mainwindow.fxml to the todoItems ArrayList
//        todoListView.setItems(TodoData.getInstance().getTodoItems());
        todoListView.setItems(sortedList);
//        Ensure only one item in ListView can be selected at a time
...
//            dialog.getDialogPane().setContent(root);
    ...
    public void editItemDialog() {
        Dialog<ButtonType> dialog = new Dialog<>();
        dialog.initOwner(mainBorderPane.getScene().getWindow());
        dialog.setTitle("Edit todo deadline");
        dialog.setHeaderText("Please select the new deadline");
        FXMLLoader fxmlLoader = new FXMLLoader();
...
//            dialog.getDialogPane().setContent(root);
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            editDialogController.processNewDeadline(todoListView.getSelectionModel().getSelectedItem());
//            todoListView.getSelectionModel().select(newItem);
        }
